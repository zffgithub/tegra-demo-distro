...
github_repos = [
    ...
    'https://github.com/osrf/negotiated.git',
]
...
def generate_ros_recipe(source_path, target_path, **kwargs):
    ...
    license = data_dict['license'] if isinstance(data_dict.get('license', 'no license'), str) else data_dict.get('license', ['no license'])[0]
    package_md5 = get_package_md5(license)
